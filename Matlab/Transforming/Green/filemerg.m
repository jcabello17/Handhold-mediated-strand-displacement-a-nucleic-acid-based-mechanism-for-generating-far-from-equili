function   Filemerg(Files,folder,destination)
...
%%
    ...
    while jjj<size(Files,1)
        ...
        if contains(ID(end),'St1')
            ...
            if contains(ID(1),'HHM')
                count=6;
            %HHR experiments are formed of 4 files
            elseif contains(ID(1),'HHR')
                count=4;
            ...
            for jj=2:count
                ...
                if exist(parche)
                    ...
                    %position
                    if jj==3 && contains(ID(1),'HHM')
                        xlswrite(write,raw,1,'A8');
                    elseif jj==2 && contains(ID(1),'HHR')
                        xlswrite(write,raw,1,'A6');
